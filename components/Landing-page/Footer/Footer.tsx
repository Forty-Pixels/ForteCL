                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.1fr_0.7fr_1fr_1.2fr] gap-6 lg:gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-500 text-xs font-medium">
                            ...
                            <li><Link href="/resources" className="hover:text-[#f88c29] transition-colors">Resources</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-gray-500 text-xs font-medium">
                            ...
                            <li className="flex items-center space-x-3">
                                ...
                                <a href="tel:+97142718226" className="hover:text-[#f88c29] transition-colors">
                                    +971 4 271 8226
                                </a>
                            </li>
                            <li className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2.5">
                            ...
                            />
                            <button className="bg-[#f88c29] hover:bg-[#e67b1d] text-white px-6 py-3 rounded-xl font-bold transition-all text-xs whitespace-nowrap shadow-md">
                                Sign Up
                            </button>
                        </div>
                    </div>
