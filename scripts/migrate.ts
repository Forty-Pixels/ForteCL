...
const packages = [
    ...
    },
    {
        ...
        subTests: [
            ...
            { title: "FSH", explanation: "Follicle Estimulating Hormone in men" },
    ...
    },
    {
        ...
        subTests: [
            ...
            { title: "Follicle Estimulating Hormone (FSH)", explanation: "Evaluation of reproductive health" },
...
async function migrate() {
    ...
    for (const pkg of packages) {
        process.stdout.write(`Migrating package: ${pkg.title}... `);
        try {
            await client.createOrReplace({
                _type: 'package',
                _id: `package-${pkg.id}`,
    ...
    console.log('\n✨ Migration Complete!');
    console.log('Note: Package images need to be uploaded manually in Sanity Studio.');
}
